...
namespace BirthdayBot.BLL.Inputs.Notes
{
    ...
    public class NoteYearInput : Input
    {
        ...
        public override async Task Execute(Update update, TelegramUser user = null, IServiceScope actionScope = null)
        {
            ...
            // Output
            await botClient.SendTextMessageAsync(update.Message.Chat.Id, resources["NOTE_MONTH_INPUT"], replyMarkup: menu.GetMarkup(), parseMode: Telegram.Bot.Types.Enums.ParseMode.Html);
        }
    }
}
